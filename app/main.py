...
from app.delivery.routes import dh_route
...
app.include_router(delivery_plan_route, prefix=f"/{version_prefix}/delivery", tags=["delivery plan"])
app.include_router(dh_route, prefix=f"/{version_prefix}/delivery", tags=["delivery"])
